...
export const panelUIbaseStyle = "fixed bottom-1 sm:bottom-2.5 left-0 right-0 w-[98%] sm:w-[90%] mx-auto border rounded-lg p-1 sm:p-4 z-[100] shadow-[0_5px_20px_rgba(0,0,0,0.5)] h-[40px] sm:h-[70px] max-h-[40px] sm:max-h-[70px] overflow-y-auto transition-all duration-300 ease-in-out";
...
export const panelUIWithResultsStyle = "h-[180px] sm:h-[300px] max-h-[180px] sm:max-h-[300px]";
//search-form
...
export const searchFormBaseStyle = "flex mb-0.5 sm:mb-4 mx-auto sticky w-full sm:w-[60%] md:w-[40%] top-0 z-[2] pb-0.5 sm:pb-2";
...
export const searchInputBaseStyle = "flex-grow px-1 py-0.5 sm:px-2.5 sm:py-2 border border-[rgba(255,255,255,0.2)] bg-[rgba(0,0,0,0.5)] rounded-l-sm outline-none focus:border-[rgba(255,215,0,0.5)] text-xs sm:text-base";
...
export const searchButtonBaseStyle = "bg-[gold] border-none text-black px-1.5 sm:px-3 py-0.5 sm:py-2 rounded-r-sm cursor-pointer font-bold transition-colors duration-200 ease-in-out text-xs sm:text-base";
...
export const searchNoResultsStyle = "text-center p-0.5 sm:p-4 text-[rgba(255,255,255,0.7)] italic w-full text-xs sm:text-base";

//in-game-search-loading
export const searchLoadingStyle = "text-center text-[rgba(255,255,255,0.7)] my-0.5 sm:my-4 italic text-xs sm:text-base";

//in-game-search-results
export const searchResultsStyle = "text-center mt-0.5 sm:mt-2.5 flex flex-wrap gap-0.5 sm:gap-2.5 justify-start";

//in-game-search-result-item
// Base result item styles
export const resultItemBaseStyle = "flex items-center p-0.5 sm:p-1.5 rounded border transition-colors duration-200 ease-in-out w-full sm:w-[calc(50%-5px)] md:w-[calc(33.33%-10px)] min-w-[100px] sm:min-w-[150px] flex-shrink-0";
...
export const resultItemExactMatchStyle = "bg-[rgba(255,215,0,0.1)] border-l-[2px] sm:border-l-[3px] border-l-[gold]";
// Can connect modifier
export const resultItemCanConnectStyle = "border-l-[2px] sm:border-l-[3px] border-l-[rgba(46,204,113,0.7)]";

//in-game-result-image
// Styles for the result image container
export const resultImageStyle = "w-[18px] h-[22px] sm:w-[30px] sm:h-[38px] mr-0.5 sm:mr-2 overflow-hidden rounded-sm flex-shrink-0";
// Image styles
export const resultImageImgStyle = "w-full h-full object-cover";

//in-game-result-info
export const resultInfoStyle = "flex-grow overflow-hidden text-[9px] sm:text-sm";

// Result title
export const resultTitleStyle = "font-medium whitespace-nowrap overflow-hidden text-ellipsis";

//in-game-result-type
export const resultTypeStyle = "text-[7px] sm:text-xs";
export const resultTypeLightStyle = "text-[rgba(0,0,0,0.6)]";
export const resultTypeDarkStyle = "text-[rgba(255,255,255,0.6)]";

//in-game-add-button
export const addButtonBaseStyle = "border rounded-sm px-0.5 py-0 sm:px-1.5 sm:py-0.5 text-[7px] sm:text-[11px] cursor-pointer transition-all duration-200 ease-in-out ml-0.5 sm:ml-1";
// Dark mode
