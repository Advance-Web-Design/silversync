...
export const connectionsContentBaseStyle = "text-center overflow-y-auto px-2 sm:px-4 pb-2 sm:pb-4 max-h-[calc(100vh-140px)] sm:max-h-[calc(100vh-160px)]";
...
//no-connection
export const noConnectionBaseStyle = "mx-auto p-4 sm:p-8 italic text-sm sm:text-base";
...
export const connectionItemBaseStyle = "flex rounded-md p-1.5 sm:p-2 transition-all duration-200 ease-in-out border hover:scale-105 cursor-pointer";
...
export const connectionDetailBaseStyle = "text-[0.75rem] sm:text-[0.8rem] mt-0.5 sm:mt-[2px] mb-1 sm:mb-[6px] whitespace-nowrap overflow-hidden text-ellipsis";
...
export const onBoardIndicatorBaseStyle = "mx-auto text-[9px] sm:text-[10px] py-0.5 px-1 sm:px-[5px] rounded-[3px] inline-block self-start mt-auto hover:scale-105 transition-transform duration-200 ease-in-out border";
...
export const connectionSectionH3BaseStyle = "mb-2 sm:mb-3 text-sm sm:text-base border-b pb-1 sm:pb-1.5";
...
export const connectionsPanelBaseStyle = "fixed top-[50px] sm:top-[60px] right-1 sm:right-[10px] w-[95vw] sm:w-[480px] max-w-[95vw] sm:max-w-[90vw] max-h-[calc(100vh-80px)] sm:max-h-[calc(100vh-100px)] rounded-lg z-[100] flex flex-col animate-slide-in shadow-[0_8px_24px_rgba(0,0,0,0.5)]";
...
export const connectionsHeaderBaseStyle = "flex justify-between items-center py-2 sm:py-3 px-2.5 sm:px-4 sticky top-0 z-[2] rounded-t-lg border-b";
...
export const connectionsHeaderH2BaseStyle = "m-0 mx-auto text-base sm:text-[1.2rem] whitespace-nowrap overflow-hidden text-ellipsis max-w-[80%] sm:max-w-[85%]";
export const connectionsHeaderH2DarkStyle = "text-[gold]";
export const connectionsHeaderH2LightStyle = "text-yellow-500";

export const closeButtonBaseStyle = "bg-transparent border-none text-xl sm:text-[22px] cursor-pointer p-0 w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center rounded-full ";
