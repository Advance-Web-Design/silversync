...
export const actorImageContainerStyle = "h-[180px] w-[130px] sm:h-[200px] sm:w-[150px] overflow-hidden rounded mt-1 sm:mt-2 mb-2 sm:mb-4 mx-auto border border-slate-600"
...
export const actorSearchResultItemStyle = "flex items-center p-1.5 sm:p-2 cursor-pointer border-b border-gray-100 text-black hover:bg-gray-300";

export const actorSearchImageStyle = "w-8 h-8 sm:w-10 sm:h-10 rounded-full overflow-hidden mr-1.5 sm:mr-2.5 flex-shrink-0";

export const actorSearchImageImgStyle = "w-full h-full object-cover";

export const actorSearchNameStyle = "text-[0.8rem] sm:text-[0.9rem] whitespace-nowrap overflow-hidden text-ellipsis";
